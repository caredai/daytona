...
class Sandbox {
    ...
    constructor(sandboxDto, clientConfig, axiosInstance, sandboxApi, codeToolbox, getToolboxBaseUrl) {
        ...
        this.fs = new FileSystem_1.FileSystem(this.clientConfig, new toolbox_api_client_1.FileSystemApi(this.clientConfig, '', this.axiosInstance), this.ensureToolboxUrl.bind(this));
        this.git = new Git_1.Git(new toolbox_api_client_1.GitApi(this.clientConfig, '', this.axiosInstance));
        this.process = new Process_1.Process(this.clientConfig, this.codeToolbox, new toolbox_api_client_1.ProcessApi(this.clientConfig, '', this.axiosInstance), getPreviewToken, this.ensureToolboxUrl.bind(this));
        this.codeInterpreter = new CodeInterpreter_1.CodeInterpreter(this.clientConfig, new toolbox_api_client_1.InterpreterApi(this.clientConfig, '', this.axiosInstance), getPreviewToken, this.ensureToolboxUrl.bind(this));
