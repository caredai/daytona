...
export declare const SnapshotsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getAllSnapshots: (xDaytonaOrganizationID?: string, page?: number, limit?: number, name?: string, sort?: GetAllSnapshotsSortEnum, order?: GetAllSnapshotsOrderEnum, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getSnapshotBuildLogsUrl: (id: string, xDaytonaOrganizationID?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
...
export declare const SnapshotsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getAllSnapshots(xDaytonaOrganizationID?: string, page?: number, limit?: number, name?: string, sort?: GetAllSnapshotsSortEnum, order?: GetAllSnapshotsOrderEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedSnapshots>>;
    /**
     *
     * @summary Get snapshot by ID or name
     * @param {string} id Snapshot ID or name
     ...
     * @throws {RequiredError}
     */
    getSnapshotBuildLogsUrl(id: string, xDaytonaOrganizationID?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Url>>;
    /**
     *
     * @summary Delete snapshot
     * @param {string} id Snapshot ID
...
export declare class SnapshotsApi extends BaseAPI {
     ...
     * @memberof SnapshotsApi
     */
    getSnapshotBuildLogsUrl(id: string, xDaytonaOrganizationID?: string, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<Url, any>>;
    /**
     *
     * @summary Delete snapshot
     * @param {string} id Snapshot ID
 ...
 * @export
 */
export declare const GetAllSnapshotsSortEnum: {
    readonly NAME: "name";
 ...
 * @export
 */
export declare const GetAllSnapshotsOrderEnum: {
    readonly ASC: "asc";
    readonly DESC: "desc";
};
