...
export declare const DockerRegistryApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getTransientPushAccess: (xDaytonaOrganizationID?: string, regionId?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
...
export declare const DockerRegistryApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getTransientPushAccess(xDaytonaOrganizationID?: string, regionId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RegistryPushAccessDto>>;
    /**
     *
     * @summary List registries
     * @param {string} [xDaytonaOrganizationID] Use with JWT to specify the organization ID
