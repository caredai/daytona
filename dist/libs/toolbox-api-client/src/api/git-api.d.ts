 ...
 * @export
 */
export declare const GitApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     * @throws {RequiredError}
     */
    cloneRepository: (request: GitCloneRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    createBranch: (request: GitBranchRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    deleteBranch: (request: GitGitDeleteBranchRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
 ...
 * @export
 */
export declare const GitApiFp: (configuration?: Configuration) => {
    /**
     * Add files to the Git staging area
     * @summary Add files to Git staging
     * @param {GitAddRequest} request Add files request
     ...
     * @throws {RequiredError}
     */
    cloneRepository(request: GitCloneRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Commit staged changes to the Git repository
     * @summary Commit changes
     * @param {GitCommitRequest} request Commit request
     ...
     * @throws {RequiredError}
     */
    createBranch(request: GitBranchRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Delete a branch from the Git repository
     * @summary Delete a branch
     * @param {GitGitDeleteBranchRequest} request Delete branch request
     ...
     * @throws {RequiredError}
     */
    deleteBranch(request: GitGitDeleteBranchRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Get the commit history of the Git repository
     * @summary Get commit history
     * @param {string} path Repository path
 ...
 * @export
 */
export declare const GitApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Add files to the Git staging area
     * @summary Add files to Git staging
     * @param {GitAddRequest} request Add files request
 ...
 * @extends {BaseAPI}
 */
export declare class GitApi extends BaseAPI {
    /**
     * Add files to the Git staging area
     * @summary Add files to Git staging
     * @param {GitAddRequest} request Add files request
