...
export declare const InfoApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    getUserHomeDir: (options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getWorkDir: (options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const InfoApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getUserHomeDir(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserHomeDirResponse>>;
    /**
     * Get the current daemon version
     * @summary Get version
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getVersion(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{
        [key: string]: string;
    }>>;
    /**
     * Get the current working directory path. This is default directory used for running commands.
     ...
     * @throws {RequiredError}
     */
    getWorkDir(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WorkDirResponse>>;
};
/**
...
export declare const InfoApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    getVersion(options?: RawAxiosRequestConfig): AxiosPromise<{
        [key: string]: string;
    }>;
    /**
     * Get the current working directory path. This is default directory used for running commands.
